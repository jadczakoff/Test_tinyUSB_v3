...
Core/tinyUSB/class/bth/%.o Core/tinyUSB/class/bth/%.su: ../Core/tinyUSB/class/bth/%.c Core/tinyUSB/class/bth/subdir.mk
...
clean-Core-2f-tinyUSB-2f-class-2f-bth:
	-$(RM) ./Core/tinyUSB/class/bth/bth_device.d ./Core/tinyUSB/class/bth/bth_device.o ./Core/tinyUSB/class/bth/bth_device.su
